...
import 'package:agri_app/ui/screens/cropStatus/mkts/mktsList/mktsListPage.dart';
import 'package:agri_app/ui/screens/cropStatus/mkts/vChain/vChainPage.dart';
...
class MktsPage extends StatelessWidget {
  final CardModel cardModel;

  const MktsPage({Key? key, required this.cardModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MktsProvider(), child:
    Consumer<MktsProvider>(
