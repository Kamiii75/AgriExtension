...
import 'highEndsVM.dart';

class HighEndsPage extends StatelessWidget {
  final CardModel cardModel;

  const HighEndsPage({Key? key, required this.cardModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => HighEndsProvider(), child:
    Consumer<HighEndsProvider>(
