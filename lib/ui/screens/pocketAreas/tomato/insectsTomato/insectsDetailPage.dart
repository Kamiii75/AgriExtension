...
import 'package:agri_app/ui/screens/pocketAreas/tomato/insectsTomato/insectsTomatoVM.dart';
...
class InsectsTomatoDetailPage extends StatelessWidget {
  final CardModel cardModel;
  final List<String> cardModelList;

  const InsectsTomatoDetailPage({Key? key, required this.cardModel, required this.cardModelList})
      : super(key: key);
