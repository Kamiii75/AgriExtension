...
import 'mktsListVM.dart';

class MktsListPage extends StatelessWidget {
  final CardModel cardModel;

  const MktsListPage({Key? key, required this.cardModel})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => MktsListProvider(), child:
    Consumer<MktsListProvider>(
